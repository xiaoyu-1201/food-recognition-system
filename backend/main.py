...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["https://food-frontend-37qo.onrender.com"],
...
async def predict_food(image: UploadFile = File(...)):
    try:
        ...
        if results and len(results[0].boxes.cls) > 0:
            ...
            BASE_URL = os.getenv("BASE_URL", "https://food-backend-1oar.onrender.com")
            response_data = {
                "detections": detections,
                "image_url": f"{BASE_URL}/uploads/{detected_filename}"
            }
